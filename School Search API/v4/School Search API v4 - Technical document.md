...
- [**3.2 Entities**](#entities)
  ...
  -   [**3.2.7 School Choice Information**](#schoolchoicetype)
  -   [**3.2.8 Next Year Application**](#applicationnextyear)
  -   [**3.2.9 Proficiency Test**](#childproficiencytest)
  -   [**3.2.10 Signature**](#signature)
  -   [**3.2.11 Not applying application**](#applicationnotapplying)
  -   [**3.2.12 Future placements**](#futureplacements)
  -   [**3.2.13 Application Answer**](#applicationanswertype)
  -   [**3.2.14 Return value**](#return-value)
...
| nextyearmaxchoices | Maximum number of schools to select for next year school choices | Y |
| currentyearmaxchoices | Maximum number of schools to select for current year school choices | Y |
| reelectionmaxchoices | Maximum number of schools to select for reelection school choices | Y |
...
| connectedschoolchoices      | List of applied connected schools   | N         |
| notconnectedschoolchoices   | List of applied not connected schools | N       |
| guaranteeschoolchoice       | The guaranteed school               | Y         |
| searchedgrade               | Applied school year                 | Y         |
| consentinfo                 | Status of the other guardians answer | Y        |


<br />
<div  id = "schoolchoicetype">

#### **3.2.7 School choice information**

</div>

The additional attributes for a school choice.

| Name                        | Description                         | Read-only |
| --------------------------- | ----------------------------------- | --------- |
| unitid                      | Id of school                        | N         |
| status                      | Status of chosen school             | Y         |
| schoolname                  | Name of the school                  | Y         |
| schoolnamewithgrades        | Name of chosen school with available grade | Y  |
| profilename                 | Name of profile                     | N         |
| wantssiblingpriority        | Sibling priority                    | N         |


<br />
<div  id = "applicationnextyear">

#### **3.2.8 Next Year Application**
...
#### **3.2.11 Not applying application**
...
#### **3.2.13 Application Answer**

</div>

The attributes for application answer.

| Name               | Description                                 | Read-only |
| ------------------ | ------------------------------------------- | --------- |
| applicationid      | Id of the application                       | N         |
| answeringguardianssn | The SSN of the answering guardian         | N         |
| answer             | The answer, either Agree or Disagree        | N         |
...
| SaveApplicationAnswer | Saves the other guardians answer to the application. |
---
