...
| applicationanswer | <a href="#applicationanswer">Svar från elevens andre vårdnadshavare</a> | |
...
| nextyearmaxchoices | Maximalt antal skolor att välja på för skolval, se <a href="#KonfiginfoMax">Max antal skolor</a>       |       |
| currentyearmaxchoices | Maximalt antal skolor att välja på för skolbyte, se <a href="#KonfiginfoMax">Max antal skolor</a>       |       |
| reelectionmaxchoices | Maximalt antal skolor att välja på för reservansökan, se <a href="#KonfiginfoMax">Max antal skolor</a>      |       |

</div>

<br />

<div id="KonfiginfoMax">

### **Max antal skolor**

Konfigurationsspecifika attribut för max antal valbara skolor för aktuellt typ av val.

| Attribut                           | Beskrivning                       | Exempel    |
 ------------------------------- | --------------------------------- |--- |
| maxnoofconnectedschools        | Max antal anslutna skolor      | 10 |
| maxnoofnotconnectedschools     | Max antal ej anslutna skolor   | 10 |
...
| futureplacements               | Information om <a href="#futureplacements">framtida placeringar</a>     |        |
...
| connectedschoolchoices      | Lista av sökta anslutna skolor, se <a href="#schoolchoicetype">Information om vald skola</a>  |   |
| notconnectedschoolchoices   | Lista av sökta ej anslutna skolor, se <a href="#schoolchoicetype">Information om vald skola</a>   |    |
| guaranteeschoolchoice       | Skolpliktsskola, se <a href="#schoolchoicetype">Information om vald skola</a>       |   |
| searchedgrade               | Sökt årskurs              | 8    |
| consentinfo               | Status på andre vårdnadshavarens svar, se <a href="#consentinfotype">svarsstatus</a>  |   |
...
| grade              | Sökt årskurs                | 7            |

</div>
<br />

<div id="schoolchoicetype">

### **Information om vald skola**

De attribut som beskriver de val av skolor som eleven gjort.

| Attribut           | Beskrivning                 | Exempel      |
| -------------------| ----------------------------| ------------ |
| unitid | Skolans id | 3017 |
| status | <a href="#admissionstatustype">Status på ansökan</a> |  |
| schoolname | Skolans namn | Sundskolan |
| schoolnamewithgrades | Namn på skolan med valbar årskurs | Sundskolan-8 |
| profilename | Namn på inriktning |  |
| wantssiblingpriority | Flagga för syskonförtur |  |


</div>
<br />

<div id="consentinfotype">

### **Svarsstatus från elevens andre vårdnadshavare**

De attribut som beskriver status på svar från elevens andre vårdnadshavare. Prefix för attributen är *consentinfo*.

| Attribut           | Beskrivning                 | Exempel      |
| -------------------| ----------------------------| ------------ |
| applicationownerssn | Personnummer på elevens andre vårdnadshavare | 199212240129 |
| consentstatus  | Se <a href="#consentstatustype">Svarsstatus</a>        | BESPK        |
...
<div id="applicationanswertype">

### **Svar från elevens andre vårdnadshavare**

De attribut som beskriver svaret från elevens andre vårdnadshavare.

| Attribut           | Beskrivning                 | Exempel      |
| -------------------| ----------------------------| ------------ |
| applicationid  | Id på ansökan |  |
| answeringguardianssn | Personnummer på vårdnadshavaren som svarar |  |
| answer  | Elevens andre vårdnadshavares svar på ansökan, se <a href="#answertype">Svar</a>        | Agree |
...
<div id="consentstatustype">

#### Status på den andre vårdnadshavarens svar
