...
Before you can get access to the Economy API, you must request a license key from Tietoevry. You should have basic knowledge of the economic terms used in Edlevo, the Swedish school system and W3C XML before you start using the API.
...
https://[host]/WE.Education.Integration.Host.Proxy/LES/Economy/v1/Economy <br/>
...
| Service| Description|
| ------ | ---------- |
| GetPreSchoolEconomy | Fetch economy information for the given calculation month. |
